...
main proc         ; Main procedure entry point
    ...
    mov bl, 1     ; Set loop counter 'bl' to 1
    mov bh, 5     ; Set upper limit 'bh' to 5

    cmp bl, bh    ; Compare current value of 'bl' with 'bh'
    jle loop      ; If 'bl' <= 'bh', jump to loop
...
loop:
    ...
    inc bl        ; Increment the value of 'bl'

    cmp bl, bh    ; Compare the updated value of 'bl' with 'bh'
    jle loop      ; If 'bl' <= 'bh', repeat the loop
