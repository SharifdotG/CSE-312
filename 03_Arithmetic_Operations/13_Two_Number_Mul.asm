...
; Program 13 - Two Number Multiplication
...
msg3 db "The multiplication is: $" ; Declare third string, ending with '$'
multiplication db ?                    ; Declare a byte to store the multiplication
...
main proc         ; Main procedure entry point
    ...
    mov ah, 2     ; Set function number 2 (Display Character) in 'ah'
    mov dl, multiplication   ; Load the value of 'multiplication' into 'dl'
